...
class CategoryScore(BaseModel):
    ...
    feedback: Optional[str] = Field(default=None, description="Specific actionable instructions to improve this section")
...
class Scores(BaseModel):
    ...
    open_source: Optional[CategoryScore] = None  # removed — kept for backward compat
...
class OllamaProvider:
    ...
    Uses the Ollama cloud API (ollama.com) when OLLAMA_API_KEY is set in the
    environment, otherwise falls back to a local Ollama instance.
    """
